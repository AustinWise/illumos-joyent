...
struct rpcb {
	...
	char* r_owner;		/* owner of this service */
};
...
typedef struct rp__list *rpcblist_ptr;		/* results of RPCBPROC_DUMP */
...
struct rpcb_rmtcallres {
	char* addr;			/* remote universal address */
	void* results;		/* result */
};
...
*/
struct rpcb_entry {
	char*		r_maddr;	/* merged address of service */
	char*		r_nc_netid;	/* netid field */
	unsigned int	r_nc_semantics;	/* semantics of transport */
	char*		r_nc_protofmly; /* protocol family */
	char*		r_nc_proto;	/* protocol name */
};
...
struct rpcb_entry_list {
	struct rpcb_entry rpcb_entry_map;
	struct rpcb_entry_list *rpcb_entry_next;
};

typedef struct rpcb_entry_list *rpcb_entry_list_ptr;
...
#define RPCBSTAT_HIGHPROC  13	/* # of procs in rpcbind V4 plus one */
#define RPCBVERS_STAT  3	/* provide only for rpcbind V2, V3 and V4 */
...
typedef struct rpcbs_rmtcalllist *rpcbs_rmtcalllist_ptr;
...
typedef struct rpcb_stat rpcb_stat_byvers[RPCBVERS_STAT];
